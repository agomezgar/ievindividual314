...
$result=mysql_query("select * from $grupo order by apellidos",$link);
while ($row=mysql_fetch_array($result)){


$nombrealumno=$row['apellidos'].",".$row['nombre'];
$nombre=$row['nombre'];
...
$pdf->AddPage();
$pdf->SetFont('Arial','B',8);
$pdf->Cell(60,5,'MATERIAS',1,0,'C',1);
$pdf->Cell(30,5,'CALIFICACIÓN',1,0,'C',1);
$pdf->Cell(20,5,'PTI SÍ/NO',1,0,'C',1);
$pdf->Cell(60,5,'REFUERZO Y/O AMPLIACIÓN',1,0,'C',1);
$pdf->Cell(20,5,'NCC',1,1,'C',1);
$pdf->SetFont('Arial','',8);
$pdf->Cell(60,5,'LENGUA CASTELLANA Y LITERATURA',1,0,L,0);
$pdf->Cell(30,5,$calificacionlengua.":".califica($calificacionlengua),1,0,L,0);
$pdf->Cell(20,5,pti($ptilengua),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1lengua),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref2lengua),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref3lengua),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref4lengua),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref5lengua),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref6lengua),1,0,L,0);
$pdf->Cell(20,5,ncc($ncclengua),1,1,'C',1);


$pdf->Cell(60,5,'INGLÉS',1,0,L,0);
$pdf->Cell(30,5,$calificacioningles.":".califica($calificacioningles),1,0,L,0);
$pdf->Cell(20,5,pti($ptiingles),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1ingles),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2ingles),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3ingles),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4ingles),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5ingles),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6ingles),1,0,L,0);
$pdf->Cell(20,5,ncc($nccingles),1,1,'C',1);

$pdf->Cell(60,5,'FRANCÉS',1,0,L,0);
$pdf->Cell(30,5,$calificacionfrances.":".califica($calificacionfrances),1,0,L,0);
$pdf->Cell(20,5,pti($ptifrances),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1frances),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2frances),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3frances),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4frances),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5frances),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6frances),1,0,L,0);
$pdf->Cell(20,5,ncc($nccfrances),1,1,'C',1);

$pdf->Cell(60,5,'MATEMÁTICAS',1,0,L,0);
$pdf->Cell(30,5,$calificacionmatematicas.":".califica($calificacionmatematicas),1,0,L,0);
$pdf->Cell(20,5,pti($ptimatematicas),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1matematicas),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2matematicas),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3matematicas),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4matematicas),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5matematicas),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6matematicas),1,0,L,0);
$pdf->Cell(20,5,ncc($nccmatematicas),1,1,'C',1);

$pdf->Cell(60,5,'CCSS, GEOGRAFIA, HISTORIA',1,0,L,0);
$pdf->Cell(30,5,$calificacionsociales.":".califica($calificacionsociales),1,0,L,0);
$pdf->Cell(20,5,pti($ptisociales),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1sociales),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2sociales),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3sociales),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4sociales),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5sociales),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6sociales),1,0,L,0);
$pdf->Cell(20,5,ncc($nccsociales),1,1,'C',1);


$pdf->Cell(60,5,'BIOLOGÍA',1,0,L,0);
$pdf->Cell(30,5,$calificacionbiologia.":".califica($calificacionbiologia),1,0,L,0);
$pdf->Cell(20,5,pti($ptibiologia),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1biologia),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2biologia),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3biologia),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4biologia),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5biologia),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6biologia),1,0,L,0);
$pdf->Cell(20,5,ncc($nccbiologia),1,1,'C',1);


$pdf->Cell(60,5,'FÍSICA Y QUÍMICA',1,0,L,0);
$pdf->Cell(30,5,$calificacionfisica.":".califica($calificacionfisica),1,0,L,0);
$pdf->Cell(20,5,pti($ptifisica),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1fisica),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2fisica),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3fisica),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4fisica),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5fisica),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6fisica),1,0,L,0);
$pdf->Cell(20,5,ncc($nccfisica),1,1,'C',1);


$pdf->Cell(60,5,'EDUCACIÓN FÍSICA',1,0,L,0);
$pdf->Cell(30,5,$calificaciongimnasia.":".califica($calificaciongimnasia),1,0,L,0);
$pdf->Cell(20,5,pti($ptigimnasia),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1gimnasia),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2gimnasia),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3gimnasia),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4gimnasia),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5gimnasia),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6gimnasia),1,0,L,0);
$pdf->Cell(20,5,ncc($nccgimnasia),1,1,'C',1);


$pdf->Cell(60,5,'EDUCACIÓN PLÁSTICA',1,0,L,0);
$pdf->Cell(30,5,$calificacionplastica.":".califica($calificacionplastica),1,0,L,0);
$pdf->Cell(20,5,pti($ptiplastica),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1plastica),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2plastica),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3plastica),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4plastica),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5plastica),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6plastica),1,0,L,0);
$pdf->Cell(20,5,ncc($nccplastica),1,1,'C',1);


$pdf->Cell(60,5,'CULTURA CLÁSICA',1,0,L,0);
$pdf->Cell(30,5,$calificaciongriego.":".califica($calificaciongriego),1,0,L,0);
$pdf->Cell(20,5,pti($ptigriego),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1griego),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2griego),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3griego),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4griego),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5griego),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6griego),1,0,L,0);
$pdf->Cell(20,5,ncc($nccgriego),1,1,'C',1);


$pdf->Cell(60,5,'MÚSICA',1,0,L,0);
$pdf->Cell(30,5,$calificacionmusica.":".califica($calificacionmusica),1,0,L,0);
$pdf->Cell(20,5,pti($ptimusica),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1musica),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2musica),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3musica),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4musica),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5musica),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6musica),1,0,L,0);
$pdf->Cell(20,5,ncc($nccmusica),1,1,'C',1);


$pdf->Cell(60,5,'TECNOLOGÍA',1,0,L,0);
$pdf->Cell(30,5,$calificaciontecnologia.":".califica($calificaciontecnologia),1,0,L,0);
$pdf->Cell(20,5,pti($ptitecnologia),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1tecnologia),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2tecnologia),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3tecnologia),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4tecnologia),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5tecnologia),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6tecnologia),1,0,L,0);
$pdf->Cell(20,5,ncc($ncctecnologia),1,1,'C',1);


$pdf->Cell(60,5,'RELIGIÓN/ALTERNATIVA',1,0,L,0);
$pdf->Cell(30,5,$calificacionreligion.":".califica($calificacionreligion),1,0,L,0);
$pdf->Cell(20,5,pti($ptireligion),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1religion),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2religion),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3religion),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4religion),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5religion),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6religion),1,0,L,0);
$pdf->Cell(20,5,ncc($nccreligion),1,1,'C',1);


$pdf->Cell(60,5,'INFORMÁTICA',1,0,L,0);
$pdf->Cell(30,5,$calificacionciudadania.":".califica($calificacionciudadania),1,0,L,0);
$pdf->Cell(20,5,pti($pticiudadania),1,0,L,0);
$pdf->Cell(10,5,"1: ".refuerzo($ref1ciudadania),1,0,L,0);
$pdf->Cell(10,5,"2: ".refuerzo($ref2ciudadania),1,0,L,0);
$pdf->Cell(10,5,"3: ".refuerzo($ref3ciudadania),1,0,L,0);
$pdf->Cell(10,5,"4: ".refuerzo($ref4ciudadania),1,0,L,0);
$pdf->Cell(10,5,"5: ".refuerzo($ref5ciudadania),1,0,L,0);
$pdf->Cell(10,5,"6: ".refuerzo($ref6ciudadania),1,0,L,0);
$pdf->Cell(20,5,ncc($nccciudadania),1,1,'C',1);
$pdf->Ln(5);
$pdf->SetFont('Arial','',5);
$pdf->Multicell(180,5,"PTI: Plan de Trabajo Individual \n MEDIDAS DE REFUERZO Y/O AMPLIACIÓN: 1: Refuerzo ordinario dentro del aula; 2: Apoyo ordinario fuera del aula; 3: Audición y Lenguaje; 4: Pedagogía Terapeútica; 5: Inmersión Lingüística; 6: Otros \n NCC: Nivel de Competencia Curricular",0); 
$pdf->Ln(5);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(40,15,'',1);
$pdf->SetXY(60,250);
$pdf->Cell(150,5,'Calzada de Calatrava, a '.fecha());
