...
?>
<?php session_start();
if (!isset ($_SESSION['identificado'])){echo "error; me has querido enga̱ar";die;}
?>
<head>
...
<table width="100%"  border="1" cellspacing="1">
 ...
 <option value="NO"<?php if($calificacionlengua==NO){echo "selected";}?>>NO</option>
    ...
    <td>      <select name="ptilengua" id="ptilengua">
        <option value=" "> </option>
        <option value="si"<?php if($ptilengua=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="ncclengua">
      ...
      <option value=4 <?php if($ncclengua==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacioningles==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptiingles" id="ptiingles">
        <option value=" "> </option>
        <option value="si"<?php if($ptiingles=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccingles">
        ...
        <option value=4 <?php if($nccingles==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacionfrances==NO){echo "selected";}?>>NO</option>    
    ...
    <td>
      <select name="ptifrances" id="ptifrances">
        <option value=" "> </option>
        <option value="si"<?php if($ptifrances=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccfrances">
        ...
        <option value=4 <?php if($nccfrances==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacionmatematicas==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptimatematicas" id="ptimatematicas">
        <option value=" "> </option>
        <option value="si"<?php if($ptimatematicas=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccmatematicas">
        ...
        <option value=4 <?php if($nccmatematicas==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacionsociales==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptisociales" id="ptisociales">
        <option value=" "> </option>
        <option value="si"<?php if($ptisociales=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccsociales">
        ...
        <option value=4 <?php if($nccsociales==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacionbiologia==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptibiologia" id="ptibiologia">
        <option value=" "> </option>
        <option value="si"<?php if($ptibiologia=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccbiologia">
        ...
        <option value=4 <?php if($nccbiologia==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacionfisica==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptifisica" id="ptifisica">
        <option value=" "> </option>
        <option value="si"<?php if($ptifisica=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccfisica">
        ...
        <option value=4 <?php if($nccfisica==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificaciongimnasia==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptigimnasia" id="ptigimnasia">
        <option value=" "> </option>
        <option value="si" <?php if($ptigimnasia=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccgimnasia">
        ...
        <option value=4 <?php if($nccgimnasia==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacionplastica==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptiplastica" id="ptiplastica">
        <option value=" "> </option>
        <option value="si"<?php if($ptiplastica=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccplastica">
        ...
        <option value=4 <?php if($nccplastica==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificaciongriego==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptigriego" id="ptigriego">
        <option value=" "> </option>
        <option value="si"<?php if($ptigriego=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccgriego">
        ...
        <option value=4 <?php if($nccgriego==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
    <td>M&Uacute;SICA</td>
...
<option value="NO"<?php if($calificacionmusica==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptimusica" id="ptimusica">
        <option value=" "> </option>
        <option value="si"<?php if($ptimusica=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccmusica">
        ...
        <option value=4 <?php if($nccmusica==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificaciontecnologia==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptitecnologia" id="ptitecnologia">
        <option value=" "> </option>
        <option value="si"<?php if($ptitecnologia=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="ncctecnologia">
        ...
        <option value=4 <?php if($ncctecnologia==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
...
<option value="NO"<?php if($calificacionreligion==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="ptireligion" id="ptireligion">
        <option value=" "> </option>
        <option value="si"<?php if($ptireligion=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccreligion">
        ...
        <option value=4 <?php if($nccreligion==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
  <tr>
    <td>INFORMATICA</td>
...
<option value="NO"<?php if($calificacionciudadania==NO){echo "selected";}?>>NO</option>
    ...
    <td>
      <select name="pticiudadania" id="pticiudadania">
        <option value=" "> </option>
        <option value="si"<?php if($pticiudadania=="si"){echo "selected";}?>>S&Iacute;</option>
    ...
    <td><select name="nccciudadania">
        ...
        <option value=4 <?php if($nccciudadania==4){echo "selected";}?>>CUARTO O SUPERIOR</option>
    </select></td>
  </tr>
</table>
